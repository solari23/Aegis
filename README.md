...
https://github.com/user-attachments/assets/bfbc8503-0044-41e9-911d-3ddd26d57409

The design allows for:
- Different types of user keys, including passwords and symmetric keys derived from RSA certificates and **passkey hardware**
...
As of November 2025, Aegis has all the functionality I originally set out to achieve. Now that I've completed adding passkey-based keys, I'm  using it myself!

#### Q: What do you plan to use it for?
The idea popped up while I was working on filing taxes. I ~~currently~~ ***used to*** store those kinds of documents securely but without good redundancy. What I wanted was a lightweight but flexible solution to plop those files into cloud storage and not have to worry about them.
...
(And since moved on to VS2026/C# 14/.Net 10)
