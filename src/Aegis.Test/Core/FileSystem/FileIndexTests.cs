...
public class FileIndexTests
{
    ...
    public void TestPreventsDoubleAdd()
    {
        ...
        Assert.ThrowsExactly<AegisInternalErrorException>(() => index.Add(testFileInfo));
        ...
        Assert.ThrowsExactly<AegisInternalErrorException>(() => index.Add(fileInfoSamePath));
        ...
        Assert.ThrowsExactly<AegisInternalErrorException>(() => index.Add(fileInfoSameId));
    }
}
